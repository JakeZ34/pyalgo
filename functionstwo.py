...
def greater_values(orig_list):
    new_list = []
    second_num = orig_list[1]
    for index in range(len(orig_list)):
        if orig_list[index] > second_num:
            new_list.append(orig_list[index])
    print(len(new_list))
    return new_list

print(greater_values([5,2,3,2,1,4]))
